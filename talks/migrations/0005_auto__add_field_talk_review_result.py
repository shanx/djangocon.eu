...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.review_result'
        db.add_column('talks_talk', 'review_result', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Talk.review_result'
        db.delete_column('talks_talk', 'review_result')
    ...
    models = {
        ...
        'talks.review': {
            ...
            'voter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'unique': 'True'})
        },
        'talks.talk': {
