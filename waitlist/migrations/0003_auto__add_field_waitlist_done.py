...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaitList.done'
        db.add_column('waitlist_waitlist', 'done', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'WaitList.done'
        db.delete_column('waitlist_waitlist', 'done')
